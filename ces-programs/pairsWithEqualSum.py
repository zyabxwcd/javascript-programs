...
1 2 3 1 4
Pairs having a sum of 2: [(1, 1)]
Pairs having a sum of 3: [(1, 2), (2, 1)]
Pairs having a sum of 4: [(1, 3), (3, 1)]
Pairs having a sum of 5: [(1, 4), (2, 3)]
Pairs having a sum of 6: [(2, 4)]
Pairs having a sum of 7: [(3, 4)]
'''
...
for sum in sum_set:
    print(f'Pairs having a sum of {sum}:', 
